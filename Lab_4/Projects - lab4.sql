...
ALTER TABLE [ProjectsImplementation].[Project] ADD 
	[UCR] [nvarchar](max) NULL,--³ì’ÿ êîðèñòóâà÷à, ùî ñòâîðèâ çàïèñ
	[DCR] [datetime2] NULL,--äàòà òà ÷àñ ñòâîðåííÿ äàíîãî çàïèñó
	[ULR] [nvarchar](max) NULL,--³ì’ÿ êîðèñòóâà÷à, ùî îñòàíí³ì çì³íèâ  çàïèñ
	[DLC] [datetime2] NULL;--äàòà òà ÷àñ îñòàííüî¿ ìîäèô³êàö³¿  çàïèñó
GO
